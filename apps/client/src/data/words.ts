export const englishWords: string[] = [
  ...
  "weight", "language", "among", "grand", "ball", "yet", "wave", "drop", "heart", "am",
  ...
  "train", "sleep", "prove", "lone", "leg", "wall", "catch", "mount", "wish", "sky",
  ...
  "gone", "jump", "baby", "eight", "village", "meet", "rock", "color", "every", "change"
];
